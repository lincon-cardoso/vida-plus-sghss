...
export default function Idioma() {
  ...
  function formatExampleDate(format: string) {
    const example = new Date(2024, 11, 31);
    const opts = {
        ...
        {LANGUAGES.map((lang) => {
          ...
          return (
            <button
              ...
              className={`${styles.languageCard} ${selected ? styles.selected : ""}`}
        ...
        <div className={styles.subSection}>
          ...
          <div className={styles.optionGrid}>
            {DATE_FORMATS.map((df) => (
              <label
                key={df.id}
                className={`${styles.optionCard} ${dateFormat === df.id ? styles.selected : ""}`}
              >
                <input
                  type="radio"
                  name="dateFormat"
        ...
        <div className={styles.subSection}>
          ...
          <div className={styles.optionGrid}>
            {TIME_FORMATS.map((tf) => (
              <label
                key={tf.id}
                className={`${styles.optionCard} ${timeFormat === tf.id ? styles.selected : ""}`}
              >
                <input
                  type="radio"
                  name="timeFormat"
      ...
      <section className={styles.section}>
        ...
        <div className={styles.optionGrid}>
          {WEEK_STARTS.map((w) => (
            <label
              key={w.id}
              className={`${styles.optionCard} ${weekStart === w.id ? styles.selected : ""}`}
            >
              <input
                type="radio"
                name="weekStart"
