...
import styles from "@/app/roles/[roles]/dashboard/medic/components/header/styles/MedicHeader.module.scss";

export default function BarraNavegacaoMedic({
  payload,
}: {
        ...
        <div className={styles.actions}>
          ...
          <div className={styles.profile} aria-label="Perfil do usuário">
            <div className={styles.profileText}>
              ...
              <div className={styles.profileRole}>Médico</div>
            </div>
